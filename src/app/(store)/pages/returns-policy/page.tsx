      ...
      <div className="space-y-10 text-[#555555]">
        ...
        <section>
          ...
          <ul className="space-y-2">
            {[
              ...
              "Item must not be damaged due to misuse or negligence",
              "Proof of purchase (order number or receipt) must be provided",
              "Perishable items, digital products, and personalised items cannot be returned",
            ].map((item, i) => (
        ...
        <section>
          ...
          <ol className="space-y-3 list-none">
            {[
              "Contact us via WhatsApp or our contact form within 30 days of delivery",
              "Provide your order number and reason for return",
              "We will send you a return authorisation and instructions",
              "Package the item securely and send it to our address",
