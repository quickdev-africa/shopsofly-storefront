  ...
  return (
    <main>
      <div className="max-w-6xl mx-auto px-4 pt-12 pb-4">
        <h1 className="font-heading text-3xl md:text-4xl font-bold text-[#1A1A1A]">Product Bundles</h1>
        <p className="text-[#555555] mt-2">Save more when you buy together — curated bundles with exclusive discounts.</p>
      </div>
